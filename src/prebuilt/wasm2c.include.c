...
"#  ifndef __SEG_GS\n"
"#    error \"No segment support\"\n"
"#  endif\n"
"\n"
"#define MEMCPY_GS(TYPE)                                         \\\n"
"static __attribute__((always_inline)) inline                    \\\n"
"void memcpyfromgs_##TYPE(TYPE* target, u32 index) {             \\\n"
"  TYPE __seg_gs * source = (TYPE __seg_gs *) (uintptr_t) index; \\\n"
"  *target = *source;                                            \\\n"
"}                                                               \\\n"
"static __attribute__((always_inline)) inline                    \\\n"
"void memcpytogs_##TYPE(u32 index, TYPE* source) {               \\\n"
...
"}\n"
"\n"
"#define DEFINE_LOAD_NORMAL(name, t1, t2, t3)                                        \\\n"
"  static inline t3 name(wasm_rt_memory_t* mem, u64 addr, const char* func_name) {   \\\n"
"    MEMCHECK(mem, addr, t1);                                                        \\\n"
"    t1 result;                                                                      \\\n"
...
"  }\n"
"\n"
"#define DEFINE_STORE_NORMAL(name, t1, t2)                                                     \\\n"
"  static inline void name(wasm_rt_memory_t* mem, u64 addr, t2 value, const char* func_name) { \\\n"
"    MEMCHECK(mem, addr, t1);                                                                  \\\n"
"    t1 wrapped = (t1)value;                                                                   \\\n"
...
"  }\n"
"\n"
"#define DEFINE_LOAD_GS(name, t1, t2, t3)                                            \\\n"
"  static inline t3 name(wasm_rt_memory_t* mem, u64 addr, const char* func_name) {   \\\n"
"    MEMCHECK(mem, addr, t1);                                                        \\\n"
"    t1 result;                                                                      \\\n"
...
"#else\n"
"#  define DEFINE_LOAD DEFINE_LOAD_NORMAL\n"
"#  define DEFINE_STORE DEFINE_STORE_NORMAL\n"
"#endif\n"
"\n"
