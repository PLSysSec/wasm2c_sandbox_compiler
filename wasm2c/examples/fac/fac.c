...
FUNC_EXPORT u32 w2centry_w2c_fac(wasm2c_sandbox_t* const sbx, u32 p0) {
  ENTRY_PROLOGUE;
  u32 ret = w2c_fac(sbx, p0);
  ENTRY_EPILOGUE;
  return ret;
}
...
FUNC_EXPORT u32 w2c_fac(wasm2c_sandbox_t* const sbx, u32 w2c_p0) {
  FUNC_PROLOGUE;
